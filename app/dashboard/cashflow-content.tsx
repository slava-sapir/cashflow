...
export function CashflowContent({
    ...
    return (
      <>
        ...
        <div className="border-t px-4 flex flex-col gap-4 justify-center"> 
           <div>
             <span className="text-muted-foreground text-sm font-bold">Income</span>
           ...
           <div>
             <span className="text-muted-foreground text-sm font-bold">Expenses</span>
             <h2 className="text-3xl">
              ${numeral(totalAnnualExpenses).format("0.0[.]00")}
              </h2>
           </div>
           <div>
             <span className="text-muted-foreground text-sm font-bold">Balance</span>
             <h2 className={cn("text-3xl font-bold", balance <= 0 ? "text-orange-500" : "text-lime-500")}>
